...
export default defineComponent({
  ...
  methods: {
    generateRandomNumber() {
      ...
      // Ensure intRandomNum1 is greater than or equal to intRandomNum2
      if (this.intRandomNum1 < this.intRandomNum2) {
        [this.intRandomNum1, this.intRandomNum2] = [
          this.intRandomNum2,
          this.intRandomNum1,
        ];
      }
